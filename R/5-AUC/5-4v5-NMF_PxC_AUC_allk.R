...
NMF_PxM_AUC <- function()
{
  ...
  for (k in c(2:kMax)){
    load( file=paste("data/patientA_NMF_C/patientA_NMF_C_", k,".RData",sep='') )
    ...
    save.image(paste("temp/3v6-AUC_NMF_PxC_k",k,".RData",sep=''))
