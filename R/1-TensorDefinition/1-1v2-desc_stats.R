...
readFiles <- function(){
  ...
  clinicalLongNom<-read.table(file="../../12Datasets/BRCA/gdacLevel_1/BRCA.clin.merged.txt", sep = "\t",
                           header = FALSE, stringsAsFactors = FALSE, na.strings = "nasrting", fill = TRUE)

  clinicalLong<-read.table(file="../../12Datasets/BRCA/gdacLevel_1/BRCA.clin.merged.txt", sep = "\t",
                           header = FALSE, stringsAsFactors = FALSE,  fill = TRUE)
